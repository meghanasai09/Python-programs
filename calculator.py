...
frame = tk.Frame(master=window, bg="grey", padx=12)
frame.pack()
entry = tk.Entry(master=frame, relief=SUNKEN, borderwidth=4, width=50)
...
button_mod = tk.Button(master=frame, text="%", padx=15, pady=5, width=3, command=lambda: myclick('%'))
button_mod.grid(row=5, column=2, pady=2)
button_clear = tk.Button(master=frame, text="clear",padx=15, pady=5, width=10, command=clear)
button_clear.grid(row=6, column=0, columnspan=1, pady=2)
button_equal = tk.Button(master=frame, text="=", padx=15,pady=5, width=10, command=equal)
button_equal.grid(row=6, column=2, columnspan=2, pady=2)
window.mainloop()